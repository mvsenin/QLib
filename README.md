...
2. QLib.qvs - includes all Qlib scripts, please note the sQVDPathPrefix variable which allows implemeting versioning of the apps and dev/test/prod environments
